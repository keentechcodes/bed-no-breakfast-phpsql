...
<div class="tm-main-content" id="top">
            ...
            <div class="row">
                ...
                <nav class="navbar navbar-expand-lg narbar-light">
                    <a class="navbar-brand mr-auto" href="#">
                        <img src="img/logo.png" alt="Site logo"> Bed no Breakfast
                    </a>
                    ...
                    <div id="mainNav" class="collapse navbar-collapse tm-bg-white">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#tm-section-4">ROOMS</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#tm-section-5">REVIEWS</a>
                            </li>
                            <li class="nav-item">
    ...
    <a href = "<?php echo BASE_URL.'signout.php'?>" class="btn-primary float-right ml-5 position-absolute round">SignOut</a>
    <div class="tm-section tm-bg-img" id="tm-section-1">
        <div class="tm-bg-white ie-container-width-fix-2">
            <div class="container ie-h-align-center-fix">
                <div class="row">
                    <div class="col-xs-12 ml-auto mr-auto ie-container-width-fix">
                        <form action="home.php" method="get" class="tm-search-form tm-section-pad-2">
        ...
        <div class="container">
            <div class="row">
                <div class="col text-center">
                    <h2 class="tm-section-title">We supply the bed not the bread</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container tm-pt-5 tm-pb-4">
            <div class="row text-center">
                <article class="col-sm-12 col-md-4 col-lg-4 col-xl-4 tm-article">
                    ...
                    <h3 class="tm-color-primary tm-article-title-1">Experience the Life of Mykonos City</h3>
                    <p>We will help you experience Mykonos life in its true sense.</p>
                ...
                <article class="col-sm-12 col-md-4 col-lg-4 col-xl-4 tm-article">
                    ...
                    <h3 class="tm-color-primary tm-article-title-1">Amenities & Facilities</h3>
                ...
                <article class="col-sm-12 col-md-4 col-lg-4 col-xl-4 tm-article">
                    ...
                    <h3 class="tm-color-primary tm-article-title-1">Our Inside Pictures</h3>
        ...
        <div class="container-fluid">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                foreach ($rooms as $room) {
                    ?>
                    <div class="row">
                        <div class="tm-bg-white m-2 col-sm-12 col-md-12 col-lg-12">
                            <div class="row">
                                <div class="m-4 col-sm-4 col-md-4">
                                    <img src="<?php echo $room['bnb_img'] ?>" alt="Image" class="img-fluid">
                                </div>
                                <div class="m-4 col-sm-6 col-md-6">
                                    <h1 class="text-uppercase"><?php echo $room['price'] ?> pesos/per night</h1>
                                    <h2><?php echo $room['bnb_guests'] ?> guests</h2>
                                    <br/>
                                    <br/>
                                    <br/>
                                    <p><?php echo $room['bnb_desc'] ?></p>
                                    <div class="container ie-h-align-center-fix">
                                        <div class="row">
                                            <div class="col-xs-12 ml-auto mr-auto ie-container-width-fix">
                                                <form action="book.php" method="get"
                                                    ...
                                                    <div class="form-row tm-search-form-row">
                                                        ...
                                                        <input type="hidden" name="id"
                                                               value="<?php echo $room['bnb_id'] ?>">
                                                        <div class="form-group tm-form-element tm-form-element-50">
                                                            <button type="submit"
                                                                    class="text-uppercase btn-primary float-right">Book
                                                                Now
                                                            </button>
                                                        </div>
                                                    </div>
            ...
            <div class="container ie-h-align-center-fix">
                <div class="row tm-flex-align-center">
                    <div class="col-xs-12 col-md-12 col-lg-3 col-xl-3 tm-media-title-container">
                        <h2 class="text-uppercase tm-section-title-2">REVIEWS</h2>
                        <h3 class="tm-color-primary tm-font-semibold tm-section-subtitle-2">What Our Guests Say</h3>
                    </div>
                        ...
                        <div class="ml-auto tm-bg-white-shadow tm-pad tm-media-container">
                            <article class="media tm-margin-b-20 tm-media-1">
                                ...
                                <div class="media-body tm-media-body-1 tm-media-body-v-center">
                                    <h3 class="tm-font-semibold tm-color-primary tm-article-title-3">Suspendisse vel est
                                        libero sem phasellus ac laoreet</h3>
                                    <p>Vivamus eget tellus ornare, sollicitudin quam id, dictum nulla. Phasellus finibus
                                        ...
                                        non.
                                        <br><br> Etiam aliquam arcu at mauris consectetur scelerisque. Integer elementum
                                        justo in orci facilisis ultricies. Pellentesque at velit ante. Duis scelerisque
                                        metus vel felis porttitor gravida.</p>
                                </div>
                            </article>
                            <article class="media tm-margin-b-20 tm-media-1">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-5 mt-3 mt-md-0">
                    <div class="tm-bg-white tm-p-4">
                        <form action="home.php" method="post" class="contact-form">
        ...
        <div class="container">
            <div class="row">
                <p class="col-sm-12 text-center tm-font-light tm-color-white p-4 tm-margin-b-0">
                    Copyright &copy; <span class="tm-current-year">2018</span> Your Company - Design: <a rel="nofollow"
